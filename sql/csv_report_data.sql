with muestra as (select * from field.muestras where idcampania = {} and idexplotacion = {} and tipo in (1,2,4)),
...
unidos as (
	select m.idlote,m.codigo, round(s.ceap::numeric,2) ceap, a.n, a.p,a.k,a.ph,a.ce,a.carbon,a.ca,a.mg,a.na,a.cic,a.ca_eq,a.mg_eq,a.k_eq,a.na_eq,a.ca_f,a.mg_f,a.k_f,a.na_f,a.s,a.mn,a.b,a.mo,a.zn,a.organi,a.cox,a.rel_cn,a.caliza,a.al,a.fe,a.cu,a.arcilla,a.limo,a.arena,a.ni,a.co,a.ti,a."as",a.pb,a.cr,a.metodo,a.no3,a.nh4
	from muestra m 
	join data d on m.codigo = d.codigo
	left join segmento s on m.codigo = s.codigo
	left join analisis a on a.cod = m.codigo
	order by m.idlote,m.segmento)
