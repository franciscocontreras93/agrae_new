...
segm_analitica as (select distinct
	...
	LEFT JOIN field.muestras m on m.idcampania = d.idcampania and m.idexplotacion = d.idexplotacion and m.idlote = d.idlote and m.segmento = s.segmento and m.status != 4 --join MUESTRAS
