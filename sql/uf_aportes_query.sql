...
segm_analitica as (select distinct
	...
	left JOIN field.muestras m on m.idcampania = d.idcampania and m.idexplotacion = d.idexplotacion and m.idlote = d.idlote and st_intersects(m.geom,s.geometria) and m.status != 4 --join MUESTRAS
