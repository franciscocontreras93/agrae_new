...
segm_analitica as (select distinct
	...
	left JOIN field.muestras m on m.idcampania = d.idcampania and m.idexplotacion = d.idexplotacion and m.idlote = d.idlote and st_intersects(m.geom,s.geometria) and m.tipo in (1,2) --join MUESTRAS
...
aportes as (
select
n.idlote, n.iddata, n.codigo,n.ambiente,n.ndvimax,n.segmento,n.ceap,n.uf, n.uf_etiqueta,n.prod_ponderada,
