...
class aGraeComposerTools():
    ...
    def layoutGenerator(self,
        ...
        self.setLegendsToLayout(layout.itemById('legend_06'),[self.layers['Fert Variable Intraparcelaria']],['Unidades Fertilziantes'])
        self.setLegendsToLayout(layout.itemById('legend_07_01'),[self.layers['Fert Variable Intraparcelaria']],['Unidades Fertilziantes'])
