...
<qgis labelsEnabled="0" symbologyReferenceScale="-1" simplifyLocal="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" minScale="100000000" readOnly="0" maxScale="0" version="3.34.11-Prizren" styleCategories="AllStyleCategories" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyAlgorithm="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" graduatedMethod="GraduatedColor" enableorderby="0" attr="dif_rinde" referencescale="-1" type="graduatedSymbol">
    <ranges>
      <range label="-19649.70 – -9824.85 kg/ha" lower="-19649.698000000000320" uuid="{53ee1110-e571-4ff4-8bef-7c8569d3e2e5}" upper="-9824.849000000000160" symbol="0" render="true"/>
      <range label="-9824.85 – -982.48 kg/ha" lower="-9824.849000000000160" uuid="{1f7cd7bc-cb20-451b-bc14-9fa91b27b54d}" upper="-982.484900000000039" symbol="1" render="true"/>
      <range label="-982.48 – 982.48 kg/ha" lower="-982.484900000000039" uuid="{480cd12c-9be4-4061-83eb-3f5f7ade597d}" upper="982.484900000000039" symbol="2" render="true"/>
      <range label="982.48 – 9824.85 kg/ha" lower="982.484900000000039" uuid="{fdda7346-cec0-4087-bcb1-c30f77fe3376}" upper="9824.849000000000160" symbol="3" render="true"/>
      <range label="9824.85 – 19649.70 kg/ha" lower="9824.849000000000160" uuid="{0d9cc43f-d0ce-40a8-b4f3-4b8259968f89}" upper="19649.698000000000320" symbol="4" render="true"/>
    </ranges>
    <symbols>
      <symbol clip_to_extent="1" is_animated="0" frame_rate="10" name="0" alpha="0.86" type="fill" force_rhr="0">
        ...
        <layer enabled="1" pass="0" id="{d8fff75a-4be6-489d-8927-fe5be8bf1c59}" locked="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
      ...
      <symbol clip_to_extent="1" is_animated="0" frame_rate="10" name="1" alpha="0.86" type="fill" force_rhr="0">
        ...
        <layer enabled="1" pass="0" id="{a27ad32d-1ed4-4fec-847c-674dd14dc60f}" locked="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
      ...
      <symbol clip_to_extent="1" is_animated="0" frame_rate="10" name="2" alpha="0.86" type="fill" force_rhr="0">
        ...
        <layer enabled="1" pass="0" id="{37174227-38ca-4d40-b229-c0db857b630e}" locked="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
      ...
      <symbol clip_to_extent="1" is_animated="0" frame_rate="10" name="3" alpha="0.86" type="fill" force_rhr="0">
        ...
        <layer enabled="1" pass="0" id="{b8fd8900-9347-459a-aff3-697d83ae7281}" locked="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
      ...
      <symbol clip_to_extent="1" is_animated="0" frame_rate="10" name="4" alpha="0.86" type="fill" force_rhr="0">
        ...
        <layer enabled="1" pass="0" id="{a8351538-00a1-4e25-b815-d11692b6ecdb}" locked="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
