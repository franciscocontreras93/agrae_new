...
<qgis simplifyDrawingTol="1" labelsEnabled="1" maxScale="0" styleCategories="AllStyleCategories" simplifyLocal="1" simplifyMaxScale="1" minScale="100000000" simplifyAlgorithm="0" version="3.28.10-Firenze" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyDrawingHints="1" readOnly="0">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" type="RuleRenderer" symbollevels="0" referencescale="-1">
    <rules key="{ce1069c3-3799-4302-b8e5-0cb36d7cec1a}">
      <rule symbol="0" key="{c1f714fd-27e3-4fb0-a925-6cff68913d77}" label="Sin Datos" filter="tipo is null"/>
      <rule symbol="1" key="{5784b601-95a8-4ce4-a9fd-67117e8ba0b3}" label="Muy Bajo" filter="&quot;tipo&quot; = 'muy bajo'"/>
      <rule symbol="2" key="{139406f4-f52b-4c5a-86c7-f6830fdf4cf9}" label="Bajo" filter="&quot;tipo&quot; = 'bajo'"/>
      <rule symbol="3" key="{9cd16289-0bcf-471e-8a0b-c0bd86e0e36b}" label="Normal" filter="&quot;tipo&quot; = 'medio'"/>
      <rule symbol="4" key="{c9bdb453-b6c6-476f-8cae-afbe93213941}" label="Alto" filter="&quot;tipo&quot; = 'alto'"/>
      <rule symbol="5" key="{6369f853-26d5-4ca6-b870-a8d632b43d4e}" label="Muy Alto" filter="&quot;tipo&quot; = 'muy alto'"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" type="fill" frame_rate="10" name="0" is_animated="0">
        ...
        <layer class="LinePatternFill" locked="0" pass="0" enabled="1">
          ...
          <symbol alpha="1" clip_to_extent="1" force_rhr="0" type="line" frame_rate="10" name="@0@0" is_animated="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory penColor="#000000" lineSizeScale="3x:0,0,0,0,0,0" lineSizeType="MM" spacingUnitScale="3x:0,0,0,0,0,0" direction="0" rotationOffset="270" scaleDependency="Area" width="15" spacing="5" showAxis="1" spacingUnit="MM" diagramOrientation="Up" penWidth="0" backgroundColor="#ffffff" scaleBasedVisibility="0" penAlpha="255" backgroundAlpha="255" labelPlacementMethod="XHeight" barWidth="5" enabled="0" opacity="1" minScaleDenominator="0" maxScaleDenominator="1e+08" sizeType="MM" sizeScale="3x:0,0,0,0,0,0" minimumSize="0" height="15">
      <fontProperties style="" bold="0" strikethrough="0" italic="0" underline="0" description="MS Shell Dlg 2,7.5,-1,5,50,0,0,0,0,0"/>
  ...
  <fieldConfiguration>
    ...
    <field name="incremento" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias index="3" field="valor" name=""/>
    <alias index="4" field="tipo" name=""/>
    <alias index="5" field="incremento" name=""/>
  </aliases>
  <defaults>
    ...
    <default field="incremento" applyOnUpdate="0" expression=""/>
  </defaults>
  <constraints>
    ...
    <constraint field="valor" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="tipo" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="incremento" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint field="idlote" desc="" exp=""/>
    <constraint field="lote" desc="" exp=""/>
    <constraint field="codigo_muestra" desc="" exp=""/>
    <constraint field="valor" desc="" exp=""/>
    <constraint field="tipo" desc="" exp=""/>
    <constraint field="incremento" desc="" exp=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column width="-1" type="field" name="idlote" hidden="0"/>
      <column width="-1" type="field" name="lote" hidden="0"/>
      <column width="-1" type="field" name="codigo_muestra" hidden="0"/>
      <column width="-1" type="field" name="incremento" hidden="0"/>
