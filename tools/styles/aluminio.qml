...
<qgis simplifyDrawingTol="1" labelsEnabled="1" maxScale="0" styleCategories="AllStyleCategories" simplifyLocal="1" simplifyMaxScale="1" minScale="100000000" simplifyAlgorithm="0" version="3.28.10-Firenze" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyDrawingHints="1" readOnly="0">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" type="RuleRenderer" symbollevels="0" referencescale="-1">
    <rules key="{2867c40f-c9bf-4fbc-8671-4bd7ad19da6f}">
      <rule symbol="0" key="{44d054e0-7898-456d-a828-864295a5dab8}" label="ND" filter="&quot;AL&quot; >= -10000.000000 AND &quot;AL&quot; &lt;= 0.000000 OR &quot;AL&quot; IS NULL"/>
      <rule symbol="1" key="{72aa8134-0399-4dad-ba7a-622e163871c4}" label="Bajo &lt;960ppm" filter="&quot;AL&quot; > 0.000000 AND &quot;AL&quot; &lt;= 900.000000"/>
      <rule symbol="2" key="{9ddec4ad-3bfa-44c1-83fe-4848c9b48ce9}" label="Normal" filter="&quot;AL&quot; > 900.000000 AND &quot;AL&quot; &lt;= 1600.000000"/>
      <rule symbol="3" key="{b49c70b3-f0b0-4d06-933a-997146266a8d}" label="Alto >1600ppm" filter="&quot;AL&quot; > 1600.000000 AND &quot;AL&quot; &lt;= 3000.000000"/>
      <rule symbol="4" key="{d8e4fa8e-c049-430d-b2d9-a4d641a979ec}" label="Elevado" filter="&quot;AL&quot; > 3000.000000 AND &quot;AL&quot; &lt;= 10000.000000"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" type="fill" frame_rate="10" name="0" is_animated="0">
        ...
        <layer class="SimpleFill" locked="0" pass="0" enabled="1">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
            <Option value="89,133,89,255" type="QString" name="color"/>
            <Option value="bevel" type="QString" name="joinstyle"/>
            <Option value="0,0" type="QString" name="offset"/>
            <Option value="3x:0,0,0,0,0,0" type="QString" name="offset_map_unit_scale"/>
            <Option value="MM" type="QString" name="offset_unit"/>
  ...
  <defaults>
    ...
    <default field="al" applyOnUpdate="0" expression=""/>
  </defaults>
  <constraints>
    ...
    <constraint field="al" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint field="idlote" desc="" exp=""/>
    <constraint field="lote" desc="" exp=""/>
    <constraint field="codigo_muestra" desc="" exp=""/>
    <constraint field="al" desc="" exp=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig sortExpression="&quot;cod_control&quot;" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column width="-1" type="field" name="al" hidden="0"/>
    </columns>
