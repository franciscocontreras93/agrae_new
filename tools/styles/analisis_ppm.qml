...
<qgis symbologyReferenceScale="-1" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" simplifyAlgorithm="0" version="3.22.13-Białowieża" simplifyLocal="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" minScale="100000000" simplifyDrawingHints="1" labelsEnabled="1" readOnly="0" maxScale="0">
  ...
  <renderer-v2 referencescale="-1" type="categorizedSymbol" attr="tipo" enableorderby="0" symbollevels="0" forceraster="0">
    <categories>
      <category value="muy bajo" symbol="0" label="Muy Bajo" render="true"/>
      <category value="bajo" symbol="1" label="Bajo" render="true"/>
      <category value="medio" symbol="2" label="Normal" render="true"/>
      <category value="alto" symbol="3" label="Alto" render="true"/>
      <category value="muy alto" symbol="4" label="Muy Alto" render="true"/>
    </categories>
    <symbols>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column name="valor" type="field" width="-1" hidden="0"/>
