...
<qgis simplifyDrawingTol="1" labelsEnabled="1" maxScale="0" styleCategories="AllStyleCategories" simplifyLocal="1" simplifyMaxScale="1" minScale="100000000" simplifyAlgorithm="0" version="3.28.10-Firenze" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyDrawingHints="1" readOnly="0">
    ...
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" type="fill" frame_rate="10" name="1" is_animated="0">
        ...
        <layer class="SimpleFill" locked="0" pass="0" enabled="1">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
            <Option value="0,81,255,255" type="QString" name="color"/>
            <Option value="bevel" type="QString" name="joinstyle"/>
            <Option value="0,0" type="QString" name="offset"/>
            <Option value="3x:0,0,0,0,0,0" type="QString" name="offset_map_unit_scale"/>
            <Option value="MM" type="QString" name="offset_unit"/>
      ...
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" type="fill" frame_rate="10" name="2" is_animated="0">
        ...
        <layer class="SimpleFill" locked="0" pass="0" enabled="1">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
            <Option value="74,173,67,255" type="QString" name="color"/>
            <Option value="bevel" type="QString" name="joinstyle"/>
            <Option value="0,0" type="QString" name="offset"/>
            <Option value="3x:0,0,0,0,0,0" type="QString" name="offset_map_unit_scale"/>
            <Option value="MM" type="QString" name="offset_unit"/>
      ...
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" type="fill" frame_rate="10" name="3" is_animated="0">
        ...
        <layer class="SimpleFill" locked="0" pass="0" enabled="1">
          <Option type="Map">
            <Option value="3x:0,0,0,0,0,0" type="QString" name="border_width_map_unit_scale"/>
            <Option value="222,53,27,255" type="QString" name="color"/>
            <Option value="bevel" type="QString" name="joinstyle"/>
            <Option value="0,0" type="QString" name="offset"/>
            <Option value="3x:0,0,0,0,0,0" type="QString" name="offset_map_unit_scale"/>
            <Option value="MM" type="QString" name="offset_unit"/>
  ...
  <fieldConfiguration>
    ...
    <field name="CIC" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="CA" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="MG" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="K" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="NA" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias index="3" field="SEGMENTO" name=""/>
    <alias index="4" field="CIC" name=""/>
    <alias index="5" field="CA" name=""/>
    <alias index="6" field="MG" name=""/>
    <alias index="7" field="K" name=""/>
    <alias index="8" field="NA" name=""/>
  </aliases>
  <defaults>
    ...
    <default field="SEGMENTO" applyOnUpdate="0" expression=""/>
    <default field="CIC" applyOnUpdate="0" expression=""/>
    <default field="CA" applyOnUpdate="0" expression=""/>
    <default field="MG" applyOnUpdate="0" expression=""/>
    <default field="K" applyOnUpdate="0" expression=""/>
    <default field="NA" applyOnUpdate="0" expression=""/>
  </defaults>
  <constraints>
    ...
    <constraint field="SEGMENTO" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="CIC" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="CA" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="MG" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="K" unique_strength="0" constraints="0" notnull_strength="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="SEGMENTO" desc="" exp=""/>
    <constraint field="CIC" desc="" exp=""/>
    <constraint field="CA" desc="" exp=""/>
    <constraint field="MG" desc="" exp=""/>
    <constraint field="K" desc="" exp=""/>
  ...
  <attributetableconfig sortExpression="&quot;cod_control&quot;" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column width="-1" type="field" name="SEGMENTO" hidden="0"/>
      <column width="-1" type="field" name="CIC" hidden="0"/>
      <column width="-1" type="field" name="CA" hidden="0"/>
      <column width="-1" type="field" name="MG" hidden="0"/>
      <column width="-1" type="field" name="K" hidden="0"/>
      <column width="-1" type="field" name="NA" hidden="0"/>
