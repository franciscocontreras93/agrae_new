...
<qgis labelsEnabled="0" symbologyReferenceScale="-1" simplifyLocal="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" minScale="100000000" readOnly="0" maxScale="0" version="3.34.11-Prizren" styleCategories="AllStyleCategories" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyAlgorithm="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" graduatedMethod="GraduatedColor" enableorderby="0" attr="pue" referencescale="-1" type="graduatedSymbol">
    <ranges>
      <range label="1.45 – 120.84 kg/kg P" lower="1.445000000000000" uuid="{8049f36b-acd3-4a40-a77e-0f15a4c01d22}" upper="120.835999999999999" symbol="0" render="true"/>
      <range label="120.84 – 170.22 kg/kg P" lower="120.835999999999999" uuid="{222ec3b6-c924-4898-87d1-c9b824da0f85}" upper="170.218199999999996" symbol="1" render="true"/>
      <range label="170.22 – 209.12 kg/kg P" lower="170.218199999999996" uuid="{3e139bf0-e406-46ef-8af7-2661804868fa}" upper="209.123999999999967" symbol="2" render="true"/>
      <range label="209.12 – 253.78 kg/kg P" lower="209.123999999999967" uuid="{c055c3e6-0b5a-42ec-9032-882e2bac731b}" upper="253.781000000000006" symbol="3" render="true"/>
      <range label="253.78 – 604.05 kg/kg P" lower="253.781000000000006" uuid="{b05f91ce-8743-4a85-907d-9fb6ee37844d}" upper="604.047000000000025" symbol="4" render="true"/>
    </ranges>
    <symbols>
      <symbol clip_to_extent="1" is_animated="0" frame_rate="10" name="0" alpha="0.86" type="fill" force_rhr="0">
        ...
        <layer enabled="1" pass="0" id="{649f4fb6-8211-497c-8060-432b5e5f4a7a}" locked="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
      ...
      <symbol clip_to_extent="1" is_animated="0" frame_rate="10" name="1" alpha="0.86" type="fill" force_rhr="0">
        ...
        <layer enabled="1" pass="0" id="{fe79e3f6-7e1f-4551-9f43-8c9b718be90c}" locked="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
      ...
      <symbol clip_to_extent="1" is_animated="0" frame_rate="10" name="2" alpha="0.86" type="fill" force_rhr="0">
        ...
        <layer enabled="1" pass="0" id="{8062580d-f3a1-4bd6-b626-e6b3db286cd3}" locked="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
      ...
      <symbol clip_to_extent="1" is_animated="0" frame_rate="10" name="3" alpha="0.86" type="fill" force_rhr="0">
        ...
        <layer enabled="1" pass="0" id="{a21e456c-569d-4722-9074-60a98cf23c02}" locked="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
      ...
      <symbol clip_to_extent="1" is_animated="0" frame_rate="10" name="4" alpha="0.86" type="fill" force_rhr="0">
        ...
        <layer enabled="1" pass="0" id="{1f2ceff6-73e6-4ca9-8b70-3a0a9c9f4ac2}" locked="0" class="SimpleFill">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
