...
dialog, _ = uic.loadUiType(os.path.join(os.path.dirname(__file__), 'ui/analitica_dialog.ui'))

class derivarPendientesDialog(QtWidgets.QDialog,dialog):
    def __init__(self,data:pd.DataFrame,parent=None):
        super(derivarPendientesDialog,self).__init__(parent)
        self.setupUi(self)
        self.df = data
